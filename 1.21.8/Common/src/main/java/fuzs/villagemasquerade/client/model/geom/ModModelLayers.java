...
public class ModModelLayers {
    ...
    public static final ModelLayerLocation HUMANOID_BABY_SANTA_HAT = MODEL_LAYERS.registerModelLayer("humanoid_baby",
            "santa_hat");
    public static final ModelLayerLocation HUSK_CLOTHING = MODEL_LAYERS.registerModelLayer("husk", "clothing");
    public static final ModelLayerLocation HUSK_BABY_CLOTHING = MODEL_LAYERS.registerModelLayer("husk_baby",
            "clothing");
    public static final ModelLayerLocation HUSK_WITCH_HAT = MODEL_LAYERS.registerModelLayer("husk", "witch_hat");
    public static final ModelLayerLocation HUSK_BABY_WITCH_HAT = MODEL_LAYERS.registerModelLayer("husk_baby",
            "witch_hat");
    public static final ModelLayerLocation HUSK_SANTA_HAT = MODEL_LAYERS.registerModelLayer("husk", "santa_hat");
    public static final ModelLayerLocation HUSK_BABY_SANTA_HAT = MODEL_LAYERS.registerModelLayer("husk_baby",
            "santa_hat");
    public static final ModelLayerLocation WITHER_SKELETON_CLOTHING = MODEL_LAYERS.registerModelLayer("wither_skeleton",
            "clothing");
    public static final ModelLayerLocation WITHER_SKELETON_BABY_CLOTHING = MODEL_LAYERS.registerModelLayer(
            "wither_skeleton_baby",
            "clothing");
    public static final ModelLayerLocation WITHER_SKELETON_WITCH_HAT = MODEL_LAYERS.registerModelLayer("wither_skeleton",
            "witch_hat");
    public static final ModelLayerLocation WITHER_SKELETON_BABY_WITCH_HAT = MODEL_LAYERS.registerModelLayer(
            "wither_skeleton_baby",
            "witch_hat");
    public static final ModelLayerLocation WITHER_SKELETON_SANTA_HAT = MODEL_LAYERS.registerModelLayer("wither_skeleton",
            "santa_hat");
