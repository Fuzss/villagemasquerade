...
public class ModModelLayers {
    static final Identifier CLOTHING_LOCATION = VillageMasquerade.id("clothing");
    static final Identifier WITCH_HAT_LOCATION = VillageMasquerade.id("witch_hat");
    static final Identifier SANTA_HAT_LOCATION = VillageMasquerade.id("santa_hat");
    ...
    static <E extends Enum<E>> E getEnumConstant(Identifier identifier, Function<String, E> valueOfInvoker) {
